        ...
        return(
             <div className="card h-100">
                <div className="card-body">
                    <h5 className="card-title">Riwayat Transaksi Terbaru</h5>
                    <div className="row" style={{overflowX:'auto', height:'300px'}}>
                        ...
                        <div className="col-12 text-center mt-2">
                            <Link to={'/report/riwayat'} className="btn btn-outline-primary border-none btn-block bg-transparent text-primary">SEMUA RIWAYAT TRANSAKSI</Link>
                        </div>
                    </div>
                </div>
                </div>
