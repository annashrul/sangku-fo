                        ...
                        <div style={{overflowX: "auto"}}>
                            ...
                            <table className="table table-hover table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th className="text-light bg-info" style={columnStyle} rowSpan="3">BONUS<br/>(T x {this.state.list!==undefined&&this.state.list.length>0?toRp(this.state.list[0].pairing_bonus):0})</th>
                                </tr>
                                <tr>
