...
class TrxMultifinance extends Component{
    constructor(props){
        super(props);
    ...
    render(){
        return (
            <Layout page="Pembayaran Multifinance" subpage="PPOB" link={"/ppob"}>
                <div className="row">
...
export default connect(mapStateToProps)(TrxMultifinance);