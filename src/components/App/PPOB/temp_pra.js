                                                                ...
                                                                <div className="inner" style={{ display: 'flex', flexWrap: 'wrap' }}>
                                                                    {
                                                                        !this.props.isLoadingSub ? typeof this.props.dataSub.data === 'object' ? this.props.dataSub.data.length > 0 ? this.props.dataSub.data.map((v, i) => {
                                                                            return (
                                                                                <div onClick={(e) => this.handleOtherCard(e, v.op_id, v.id)} style={{ cursor: "pointer", backgroundColor: v.id === this.state.idOperator ? "#00838d" : "", flex: "auto", marginRight: '5px', paddingBottom: "5px" }} className="cards card1">
