                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <div className="row">
                                                                ...
                                                                <div className="col-md-4">
                                                                    <button type="button" className={`btn btn-${this.state.isOtp ? 'success' : 'primary'} btn-block`} onClick={(e) => this.handleOtp(e)} disabled={this.state.isOtp} style={{ padding: '7px' }} >{this.state.isOtp ? 'Terverifikasi' : 'Verifikasi'}</button>
                                                                </div>
                                                            </div>
