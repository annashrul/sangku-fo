...
class PenarikanReportExcel extends Component{
    constructor(props){
        super(props);
    ...
    printDocument = (e) => {
      ...
      printDocumentXLsx = (e,param) => {
        ...
        let raw = typeof this.props.penarikanReportExcel.data === 'object'?this.props.penarikanReportExcel.data.map(v => [
            v.kd_trx,
        ...
        let exportFileName = `Laporan_Penarikan_${moment(new Date()).format('YYYYMMDDHHMMss')}.${param==='csv'?`csv`:`xlsx`}`;
    ...
    render(){
        ...
        return (
            <WrapperModal isOpen={this.props.isOpen && this.props.type === "formPenarikanExcel"} size={this.state.view === false?'md':'xl'} aria-labelledby="contained-modal-title-vcenter" centered keyboard>
                {/* <ModalHeader toggle={this.toggle}>{this.props.detail===undefined?"Manage Export":"Update PenarikanExcel"}</ModalHeader> */}
                                    ...
                                    <div className="gallery-text-area">
                                        <div className="gallery-icon" onClick={(e => this.toggle(e))}>
                                            <ReactHTMLTableToExcel
                                                ...
                                                table={'laporan_penarikan'}
                                                filename={'laporan_penarikan'}
                                                sheet="kas"
...
const mapStateToProps = (state) => {
    ...
    return {
        ...
        persenDl: state.penarikanReducer.persenDl,
        penarikanReportExcel:state.penarikanReducer.data_report_excel,
        isOpen: state.modalReducer,
        type: state.modalTypeReducer,
    }
}
export default connect(mapStateToProps)(PenarikanReportExcel);