                                                    ...
                                                    <div className="inner" style={{ display: 'flex', flexWrap: 'wrap' }}>
                                                        {
                                                            !this.props.isLoadingKurir ? this.state.dataKurir.length > 0 ? this.state.dataKurir.map((v, i) => {
                                                                return (
                                                                    <div key={i} onClick={event => this.handleChangeKurir(v)} style={{ cursor: "pointer", backgroundColor: v.kurir === this.state.kurir ? "#00838d" : "", flex: "auto", marginRight: '5px', paddingBottom: "5px" }} className="cards card1">
