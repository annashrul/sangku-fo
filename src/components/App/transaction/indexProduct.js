                                                    ...
                                                    <div className="product-sell-info">
                                                        <div className="row">
                                                            <div className="col-6 text-center border-right">
                                                                <span className="font-17 text-dark mb-0 font-weight-bold">70 %</span>
                                                                <span className="d-block font-14">Last week</span>
                                                            </div>
                                                            <div className="col-6 text-center">
                                                                <span className="font-17 text-dark mb-0 font-weight-bold">25 %</span>
                                                                <span className="d-block font-14">Last month</span>
                                                            </div>
                                                        </div>
                                                    </div>
